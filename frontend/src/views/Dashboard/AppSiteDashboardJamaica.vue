...
export default {
  ...
  methods: {
    navigateToEdit(id) {
      this.$router.push(`/site_managementguatemala/edit/${id}`);
    },
    activateSite(id) {
      const form = {
        is_active: 1,
      ...
      axios
        .put(`/sites_activate/${id}`, form, config)
        .then((response) => {
    ...
    deactivateSite(id) {
      ...
      axios
        .put(`/sites_deactivate/${id}`, form, config)
        .then((response) => {
          console.log(response.data);
          this.is_active = "";
          this.getSites();
    ...
    async getSites() {
      try {
        ...
        await axios
          .get("http://10.109.2.112:8081/api/sites5", config)
          .then((response) => {
    ...
    async getSites2() {
      try {
        ...
        await axios
          .get("http://10.109.2.112:8081/api/sites6", config)
          .then((response) => {
            console.log("Response received:", response.data);
    ...
    addSite() {
      ...
      axios
        .post("http://10.109.2.112:8081/api/sites3", formData, config)
        .then((response) => {
          console.log(response.data);
          this.name = "";
          this.description = "";
