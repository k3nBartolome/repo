...
export default {
  ...
  methods: {
    activateProgram(id) {
      ...
      axios
        .put("https://10.236.103.190/api/programs_activate/" + id, form)
        .then((response) => {
    ...
    deactivateProgram(id) {
      ...
      axios
        .put("https://10.236.103.190/api/programs_deactivate/" + id, form)
        .then((response) => {
          console.log(response.data);
          this.is_active = "";
          this.getPrograms3();
    ...
    async getPrograms4() {
      await axios
        .get("https://10.236.103.190/api/programs4")
        .then((response) => {
    ...
    addProgram() {
      ...
      axios
        .post("https://10.236.103.190/api/programs", formData)
        .then((response) => {
          console.log(response.data);
          this.name = "";
          this.description = "";
