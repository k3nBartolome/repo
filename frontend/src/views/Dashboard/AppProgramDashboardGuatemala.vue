...
export default {
  ...
  methods: {
    ...
    activateProgram(id) {
      ...
      axios
        .put(`https://10.236.102.139/api/programs_activate/${id}`, form, config)
        .then((response) => {
    ...
    deactivateProgram(id) {
      ...
      axios
        .put(
          `https://10.236.102.139/api/programs_deactivate/${id}`,
          form,
          config
        )
    ...
    async getPrograms() {
      try {
        const response = await axios.get(
          "https://10.236.102.139/api/programs7",
          {
            headers: {
              Authorization: `Bearer ${this.$store.state.token}`,
            },
    ...
    async getPrograms2() {
      try {
        const response = await axios.get(
          "https://10.236.102.139/api/programs8",
          {
            headers: {
              Authorization: `Bearer ${this.$store.state.token}`,
            },
    ...
    addProgram() {
      ...
      axios
        .post("https://10.236.102.139/api/programsother", formData, {
          headers: {
            Authorization: `Bearer ${this.$store.state.token}`,
          },
        })
