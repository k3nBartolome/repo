...
export default {
  ...
  methods: {
    ...
    activateSite(id) {
      ...
      axios
        .put("http://10.109.2.112:8000/api/sites_activate/" + id, form)
        .then((response) => {
    ...
    deactivateSite(id) {
      ...
      axios
        .put("http://10.109.2.112:8000/api/sites_deactivate/" + id, form)
        .then((response) => {
          console.log(response.data);
          this.is_active = "";
          this.getSites();
    ...
    async getSites() {
      await axios
        .get("http://10.109.2.112:8000/api/sites")
        .then((response) => {
    ...
    async getSites2() {
      await axios
        .get("http://10.109.2.112:8000/api/sites2")
        .then((response) => {
    ...
    addSite() {
      ...
      axios
        .post("http://10.109.2.112:8000/api/sites", formData)
        .then((response) => {
          console.log(response.data);
          this.name = "";
          this.description = "";
