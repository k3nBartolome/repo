...
export default {
  ...
  methods: {
    activateSite(id) {
      ...
      axios
        .put("https://10.236.103.168/api/sites_activate/" + id, form)
        .then((response) => {
    ...
    deactivateSite(id) {
      ...
      axios
        .put("https://10.236.103.168/api/sites_deactivate/" + id, form)
        .then((response) => {
          console.log(response.data);
          this.is_active = "";
          this.getSites();
    ...
    async getSites2() {
      await axios
        .get("https://10.236.103.168/api/sites4")
        .then((response) => {
    ...
    addSite() {
      ...
      axios
        .post("https://10.236.103.168/api/sites2", formData)
        .then((response) => {
          console.log(response.data);
          this.name = "";
          this.description = "";
