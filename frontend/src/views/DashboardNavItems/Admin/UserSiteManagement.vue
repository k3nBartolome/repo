  ...
  <div class="container mx-auto p-4">
    ...
    <div class="flex justify-end mb-4">
      <input
        ...
        class="px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring focus:border-blue-300 w-full max-w-sm"
      />
    </div>
    ...
    <div class="overflow-x-auto">
      <table v-if="!loading" class="min-w-full table-auto border-collapse border border-gray-200">
        <thead>
    ...
    >
      <div class="bg-white p-6 rounded-lg w-full max-w-md">
        <h3 class="text-lg font-semibold mb-4">Assign Sites to {{ selectedUser.name }}</h3>
