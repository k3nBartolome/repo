  ...
  methods: {
    async getRoles() {
      try {
        ...
        const response = await axios.get(
          "http://10.109.2.112:8081/api/list_role",
          {
            headers: {
    ...
    async postUser() {
      try {
        ...
        const response = await axios.post(
          "http://10.109.2.112:8081/api/create_user",
          postData,
          config
        );
    ...
    async getUsers() {
      try {
        const token = this.$store.state.token;
        const response = await axios.get(
          "http://10.109.2.112:8081/api/list_user",
          {
            headers: {
              Authorization: `Bearer ${token}`,
            },
    ...
    async deleteUsers(user_id) {
      try {
        ...
        const response = await axios.delete(
          `http://10.109.2.112:8081/api/delete_user/${user_id}`,
          {
            headers: {
              Authorization: `Bearer ${token}`,
            },
