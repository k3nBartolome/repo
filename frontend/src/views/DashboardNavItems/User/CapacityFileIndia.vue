          ...
          >
            ...
            <td class="px-2 py-2 truncate">
              <div class="flex justify-center mt-2">
                <router-link :to="`/pushbackcapfileindia/${classes.id}`">
                  <button
                ...
                <router-link :to="`/cancelcapfileindia/${classes.id}`">
                  <button
                ...
                <router-link :to="`/editcapfileindia/${classes.id}`">
                  <button
...
export default {
  ...
  methods: {
    ...
    async getPrograms() {
      ...
      await axios
        .get(
          `http:///api/programs_selected/${this.sites_selected}`
        )
        .then((response) => {
    ...
    async getDateRange() {
      ...
      await axios
        .get(
          `http:///api/daterange_selected/${this.month_selected}`
        )
        .then((response) => {
