  ...
  methods: {
    async openModalForWorkExp(id) {
      ...
      try {
        ...
        const response = await axios.get(
          `https://10.236.103.168/api/applicants/${id}`,
          {
            headers: {
    ...
    async fetchData() {
      ...
      try {
        ...
        const response = await axios.get(
          "https://10.236.103.168/api/applicants",
          {
            headers: {
              Authorization: `Bearer ${token}`,
            },
    ...
    async getDates() {
      try {
        const token = this.$store.state.token;
        const response = await axios.get(
          "https://10.236.103.168/api/applicantsDate",
          {
            headers: {
              Authorization: `Bearer ${token}`,
            },
    ...
    async exportToExcel() {
      ...
      try {
        ...
        const response = await axios.get(
          "https://10.236.103.168/api/applicantsExport",
          {
            params: {
              filter_lastname: this.filterLastName,
              filter_firstname: this.filterFirstName,
