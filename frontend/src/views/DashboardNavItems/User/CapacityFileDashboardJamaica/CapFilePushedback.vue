  ...
  methods: {
    async getClassesSite() {
      try {
        ...
        const response = await axios.get(
          "https://10.236.103.168/api/siteclassesjamaicamoved",
          {
            headers: {
    ...
    async getClassesAll() {
      try {
        ...
        const token = this.$store.state.token;
        const response = await axios.get(
          "https://10.236.103.168/api/classesdashboardjamaica4",
          {
            headers: {
              Authorization: `Bearer ${token}`,
            },
    ...
    async getMonth() {
      try {
        const token = this.$store.state.token;
        const response = await axios.get("https://10.236.103.168/api/months", {
          headers: {
            Authorization: `Bearer ${token}`,
          },
        });
    ...
    async exportToExcel() {
      ...
      try {
        ...
        const response = await axios.get("https://10.236.103.168/api/export4", {
          headers: {
            Authorization: `Bearer ${token}`,
          },
    ...
    async getDateRange() {
      ...
      try {
        ...
        const url = `https://10.236.103.168/api/daterange_select/${monthId.join(
          ","
        )}`;
