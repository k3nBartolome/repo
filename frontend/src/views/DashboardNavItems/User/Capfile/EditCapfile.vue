...
export default {
  ...
  try {
    ...
    const response = await axios.get("http://i/classesall",{
          headers: {
...
,
  ...
  try {
    ...
    const response = await axios.get(`http://i/classes/${this.$route.params.id}`, { headers });
...
async getTransaction() {
  try {
    ...
    const response = await axios.get(`http://i/transaction/${this.$route.params.id}`, { headers });
...
,
  ...
  axios
    .put(
      `http://i/classes/edit/${this.$route.params.id}`,
      formData,
      { headers }
    )
    .then((response) => {
