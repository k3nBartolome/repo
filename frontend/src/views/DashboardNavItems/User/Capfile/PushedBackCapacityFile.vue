        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-5">
          <label class="block">
            ...
            <select
              ...
              disabled
              class="block w-full mt-1 border rounded-md focus:border-orange-600 focus:ring focus:ring-orange-600 focus:ring-opacity-100 bg-gray-300"
              required
              @change="getSites"
            >
          ...
          <label class="block">
            ...
            <select
              ...
              class="bg-gray-300 block w-full mt-1 border rounded-md focus:border-orange-600 focus:ring focus:ring-orange-600 focus:ring-opacity-100"
            >
              <option disabled value="" selected>Please select one</option>
          ...
          <label class="block"
            ...
            <input
              ...
              class="bg-gray-300 block w-full mt-1 border rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-100"
          ...
          <label class="block"
            ...
            <input
              type="date"
              v-model="pushback_start_date__ta"
              class="block w-full mt-1 border rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-100"
            />
          </label>
          <label class="block"
            ...
            <input
              type="date"
              v-model="pushback_start_date__wf"
              class="block w-full mt-1 border rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-100"
            />
          </label>
          <label class="block"
...
export default {
  ...
  methods: {
    ...
    pushClass() {
      ...
      axios
        .post("http://127.0.0.1:8000/api/classes/{id}/pushedback", formData)
        .then((response) => {
