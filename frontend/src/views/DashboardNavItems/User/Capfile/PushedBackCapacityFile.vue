  ...
  methods: {
    async checkClassExists2() {
      try {
        ...
        const response = await axios.get(
          "http://10.109.2.112:8000/api/class_exists2",
          {
            params: {
    ...
    async getPayrate() {
      ...
      try {
        ...
        const response = await axios.get(
          `http://10.109.2.112:8000/api/get_payrate/${this.programs_selected}`,
          { headers }
        );
    ...
    pushClass() {
      ...
      axios
        .put(
          `http://10.109.2.112:8000/api/classes/pushedback/${this.$route.params.id}`,
          formData,
          {
            headers: {
              Authorization: `Bearer ${token}`,
