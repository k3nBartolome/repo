...
export default {
  ...
  methods: {
    ...
    async getClassesAll() {
      try {
        const response = await axios.get(
          "https://10.236.102.139/api/classesallindia"
        );
    ...
    async deleteClasses() {
      await axios
        .delete("https://10.236.102.139/api/classes/" + this.$route.params.id)
        .then((response) => {
    ...
    async getClasses() {
      await axios
        .get("https://10.236.102.139/api/classes/" + this.$route.params.id)
        .then((response) => {
    ...
    async getTransaction() {
      await axios
        .get("https://10.236.102.139/api/transaction/" + this.$route.params.id)
        .then((response) => {
    ...
    editClass() {
      ...
      axios
        .put(
          "https://10.236.102.139/api/classes/edit/" + this.$route.params.id,
          formData
        )
        .then((response) => {
