...
export default {
  ...
  methods: {
    ...
    async getClassesAll() {
  try {
    const response = await axios.get("http://i/classesallindia");
    ...
    async deleteClasses() {
      await axios
        .delete("http://i/classes/" + this.$route.params.id)
        .then((response) => {
    ...
    async getClasses() {
      await axios
        .get("http://i/classes/" + this.$route.params.id)
        .then((response) => {
    ...
    editClass() {
      ...
      axios
        ...
        .then((response) => {
          ...
          this.op = "";
          this.wave_no="";
          this.$router.push("http://i/capfileindia", () => {
            location.reload();
          });
        })
        .catch((error) => {
