...
export default {
  ...
  methods: {
    ...
    async getSites() {
      ...
      await axios
        .get("https://10.236.103.168/api/sites3")
        .then((response) => {
    ...
    async getPrograms() {
      ...
      await axios
        .get("https://10.236.103.168/api/programs3")
        .then((response) => {
    ...
    async getTransaction() {
      await axios
        .get("https://10.236.103.168/api/transaction/" + this.$route.params.id)
        .then((response) => {
    ...
    async getDateRange() {
      ...
      await axios
        .get("https://10.236.103.168/api/daterange")
        .then((response) => {
    ...
    async getClasses() {
      await axios
        .get("https://10.236.103.168/api/classes/" + this.$route.params.id)
        .then((response) => {
    ...
    cancelClass() {
      ...
      axios
        .put(
          "https://10.236.103.168/api/classes/cancel/" + this.$route.params.id,
          formData
        )
        .then((response) => {
