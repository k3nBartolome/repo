  ...
  methods: {
    ...
    async getSites() {
      try {
        ...
        const response = await axios.get("https://10.109.2.112/api/sites7", {
          headers: {
    ...
    async deleteClasses() {
      ...
      await axios
        .delete(`https://10.109.2.112/api/classes/${this.$route.params.id}`, {
          headers,
        })
        .then((response) => {
    ...
    async getPrograms() {
      ...
      try {
        ...
        const response = await axios.get(
          "https://10.109.2.112/api/programs7",
          {
            headers,
          }
        );
    ...
    async getDateRange() {
      ...
      try {
        ...
        const response = await axios.get(
          "https://10.109.2.112/api/daterangeall",
          { headers }
        );
    ...
    editClass() {
      ...
      axios
        .put(
          `https://10.109.2.112/api/classes/edit/${this.$route.params.id}`,
          formData,
          { headers }
        )
        .then((response) => {
