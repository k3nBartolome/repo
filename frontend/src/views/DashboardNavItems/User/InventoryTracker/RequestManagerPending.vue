...
export default {
  ...
  methods: {
    ...
    approvedRequest(id) {
      ...
      axios
        .put(
          `https://10.109.2.112/api/inventory/approved/${id}`,
          form,
          config
        )
        .then((response) => {
    ...
    deniedRequest(id) {
      ...
      axios
        .put(`https://10.109.2.112/api/inventory/denied/${id}`, form, config)
        .then((response) => {
          console.log(response.data.data);
          this.getInventory();
    ...
    cancelledRequest(id) {
      ...
      axios
        .put(`https://10.109.2.112/api/inventory/cancel/${id}`, form, config)
        .then((response) => {
          console.log(response.data.data);
          this.getInventory();
    ...
    async getInventory() {
      try {
        ...
        const response = await axios.get(
          "https://10.109.2.112/api/inventory",
          {
            headers: {
