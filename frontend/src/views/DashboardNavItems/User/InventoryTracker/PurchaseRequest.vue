          ...
          <form @submit.prevent="addItems" class="grid grid-cols-1 gap-4 font-semibold sm:grid-cols-2 md:grid-cols-1">
            ...
            <div class="col-span-1">
              <label class="block">
                ...
                <input type="text" v-model="estimated_cost" class="block w-full whitespace-nowrap rounded-l border border-r-0 border-solid border-neutral-300 px-2 py-[0.17rem] text-center text-sm font-normal leading-[1.5] text-neutral-700 dark:border-neutral-600 dark:text-neutral-200 dark:placeholder:text-neutral-200"  />
              </label>
            </div>
            <div class="col-span-1">
              <label class="block">
                Total Estimated Cost
                <input type="text" v-model="total_estimated_cost" class="block w-full whitespace-nowrap rounded-l border border-r-0 border-solid border-neutral-300 px-2 py-[0.17rem] text-center text-sm font-normal leading-[1.5] text-neutral-700 dark:border-neutral-600 dark:text-neutral-200 dark:placeholder:text-neutral-200"  />
              </label>
            </div>
