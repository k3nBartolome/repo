  ...
  methods: {
    ...
    async getClassesSite() {
      try {
        ...
        const response = await axios.get(
          "https://10.236.103.190/api/siteclasses",
          {
            headers: {
    ...
    async getClassesInternal() {
      try {
        const token = this.$store.state.token;
        const response = await axios.get(
          "https://10.236.103.190/api/classesdashboardinternal",
          {
            headers: {
              Authorization: `Bearer ${token}`,
            },
    ...
    async getClassesExternal() {
      try {
        const token = this.$store.state.token;
        const response = await axios.get(
          "https://10.236.103.190/api/classesdashboardexternal",
          {
            headers: {
              Authorization: `Bearer ${token}`,
            },
    ...
    async getClassesB2() {
      try {
        const token = this.$store.state.token;
        const response = await axios.get(
          "https://10.236.103.190/api/b2percentage",
          {
            headers: {
              Authorization: `Bearer ${token}`,
            },
    ...
    async getClassesAll() {
      try {
        ...
        const token = this.$store.state.token;
        const response = await axios.get(
          "https://10.236.103.190/api/classesdashboard",
          {
            headers: {
              Authorization: `Bearer ${token}`,
            },
