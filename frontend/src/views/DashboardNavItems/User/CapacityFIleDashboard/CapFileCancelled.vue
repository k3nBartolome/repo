  ...
  methods: {
    ...
    async getClassesSite() {
      try {
        ...
        const response = await axios.get(
          "http://10.109.2.112:8000/api/siteclassescancelled",
          {
            headers: {
    ...
    async getClassesAll() {
      try {
        ...
        const token = this.$store.state.token;
        const response = await axios.get(
          "http://10.109.2.112:8000/api/classesdashboard3",
          {
            headers: {
              Authorization: `Bearer ${token}`,
            },
    ...
    async exportToExcel() {
      ...
      try {
        ...
        const response = await axios.get("http://10.109.2.112:8000/api/export3", {
          headers: {
            Authorization: `Bearer ${token}`,
          },
