  ...
  methods: {
    async getSites() {
      try {
        ...
        const response = await axios.get("http://10.109.2.112:8000/api/sitev2", {
          headers: {
    ...
    async getLob(filterSite = "") {
      try {
        const token = this.$store.state.token;
        const response = await axios.get("http://10.109.2.112:8000/api/lobv2", {
          headers: {
            Authorization: `Bearer ${token}`,
          },
          params: {
    ...
    async fetchData() {
      ...
      try {
        ...
        const response = await axios.get(
          "http://10.109.2.112:8000/api/classes_information",
          {
            params: {
              filter_site: this.filterSite,
              filter_lob: this.filterLob,
    ...
    async exportToExcel() {
      ...
      try {
        ...
        const response = await axios.get(
          "http://10.109.2.112:8000/api/classes_information_export",
          {
            params: {
              filter_site: this.filterSite,
              filter_lob: this.filterLob,
