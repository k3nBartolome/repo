  ...
  methods: {
    ...
    async getClassesSite() {
      try {
        ...
        const response = await axios.get(
          "https://10.236.102.139/api/siteclassesguatemalamoved",
          {
            headers: {
    ...
    async getClassesAll() {
      try {
        ...
        const token = this.$store.state.token;
        const response = await axios.get(
          "https://10.236.102.139/api/classesdashboardguatemala4",
          {
            headers: {
              Authorization: `Bearer ${token}`,
            },
    ...
    async exportToExcel() {
      ...
      try {
        ...
        const response = await axios.get("https://10.236.102.139/api/export4", {
          headers: {
            Authorization: `Bearer ${token}`,
          },
