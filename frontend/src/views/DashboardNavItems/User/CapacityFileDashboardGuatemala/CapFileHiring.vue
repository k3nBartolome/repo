  ...
  methods: {
    ...
    async getClassesSite() {
      try {
        ...
        const response = await axios.get(
          "http://10.109.2.112:8000/api/siteclassesguatemala",
          {
            headers: {
    ...
    async getClassesB2() {
      try {
        const token = this.$store.state.token;
        const response = await axios.get(
          "http://10.109.2.112:8000/api/b2percentageguatemala",
          {
            headers: {
              Authorization: `Bearer ${token}`,
            },
    ...
    async getClassesAll() {
      try {
        ...
        const token = this.$store.state.token;
        const response = await axios.get(
          "http://10.109.2.112:8000/api/classesdashboardguatemala",
          {
            headers: {
              Authorization: `Bearer ${token}`,
            },
    ...
    async getSites() {
      try {
        const token = this.$store.state.token;
        const response = await axios.get("http://10.109.2.112:8000/api/sites7", {
          headers: {
            Authorization: `Bearer ${token}`,
          },
        });
