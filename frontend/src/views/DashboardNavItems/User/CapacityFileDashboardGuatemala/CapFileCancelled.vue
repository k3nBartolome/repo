  ...
  methods: {
    ...
    async getClassesSite() {
      try {
        ...
        const response = await axios.get(
          "https://10.236.103.190/api/siteclassesguatemalacancelled",
          {
            headers: {
    ...
    async getClassesAll() {
      try {
        ...
        const token = this.$store.state.token;
        const response = await axios.get(
          "https://10.236.103.190/api/classesdashboardguatemala3",
          {
            headers: {
              Authorization: `Bearer ${token}`,
            },
    ...
    async exportToExcel() {
      ...
      try {
        ...
        const response = await axios.get("https://10.236.103.190/api/export3", {
          headers: {
            Authorization: `Bearer ${token}`,
          },
