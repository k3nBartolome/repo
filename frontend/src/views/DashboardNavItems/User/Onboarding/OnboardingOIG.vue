...
export default {
  ...
  methods: {
    ...
    submitForm() {
      ...
      formData.append("oig_validity_date", this.oig_validity_date);
      formData.append("oig_printed_date", this.oig_printed_date);
      formData.append("oig_remarks", this.oig_remarks);

      if (this.oig_proof) {
        const file = this.dataURLtoBlob(this.oig_proof);
        formData.append("oig_image", file);
      }
