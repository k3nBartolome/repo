...
export default {
  ...
  methods: {
    ...
    submitForm() {
      ...
      formData.append("bgc_validity_date", this.bgc_validity_date);
      formData.append("bgc_printed_date", this.bgc_printed_date);
      formData.append("bgc_remarks", this.bgc_remarks);

      if (this.bgc_proof) {
        const file = this.dataURLtoBlob(this.bgc_proof);
        formData.append("bgc_image", file);
      }
