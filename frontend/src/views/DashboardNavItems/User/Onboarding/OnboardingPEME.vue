...
export default {
  ...
  methods: {
    ...
    submitForm() {
      ...
      formData.append("peme_validity_date", this.peme_validity_date);
      formData.append("peme_printed_date", this.peme_printed_date);
      formData.append("peme_remarks", this.peme_remarks);

      if (this.peme_proof) {
        const file = this.dataURLtoBlob(this.peme_proof);
        formData.append("peme_image", file);
      }
