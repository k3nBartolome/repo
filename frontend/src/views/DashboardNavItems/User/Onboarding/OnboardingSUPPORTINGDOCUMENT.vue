...
mounted() {
  ...
  methods: {
    async fetchSdData() {
      try {
        const response = await axios.get(
          `https://10.109.2.112/api/get/supporting_documents/requirement/${this.$route.params.id}`
        );
    ...
    async submitForm() {
      ...
      try {
        const apiUrl = `https://10.109.2.112/api/update/supporting_documents/requirement/${this.$route.params.id}`;
