...
export default {
  ...
  methods: {
    uploadImage(event) {
      ...
      reader.onload = () => {
        this.supporting_documents_proof = reader.result;
      };
      if (file) {
    ...
    submitForm() {
      ...
      formData.append(
        "supporting_documents_validity_date",
        this.supporting_documents_validity_date
      );
      formData.append(
        "supporting_documents_printed_date",
        this.supporting_documents_printed_date
      );
      formData.append(
        "supporting_documents_remarks",
      ...
      if (this.supporting_documents_proof) {
        const file = this.dataURLtoBlob(this.supporting_documents_proof);
        formData.append("supporting_documents_image", file);
      }
