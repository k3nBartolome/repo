 ...
 mounted() {
  ...
  methods: {
    async fetchBcData() {
      try {
        const response = await axios.get(
          `https://10.109.2.112/api/get/birth_certificate/requirement/${this.$route.params.id}`
        );
    ...
    async submitForm() {
      ...
      try {
        const apiUrl = `https://10.109.2.112/api/update/birth_certificate/requirement/${this.$route.params.id}`;
