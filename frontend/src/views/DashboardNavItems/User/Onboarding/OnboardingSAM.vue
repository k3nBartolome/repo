...
export default {
  ...
  methods: {
    ...
    submitForm() {
      ...
      formData.append("sam_validity_date", this.sam_validity_date);
      formData.append("sam_printed_date", this.sam_printed_date);
      formData.append("sam_remarks", this.sam_remarks);

      if (this.sam_proof) {
        const file = this.dataURLtoBlob(this.sam_proof);
        formData.append("sam_image", file);
      }
