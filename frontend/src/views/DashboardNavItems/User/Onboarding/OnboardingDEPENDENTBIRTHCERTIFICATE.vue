...
export default {
  ...
  methods: {
    uploadImage(event) {
      ...
      reader.onload = () => {
        this.dependent_birth_certificate_proof = reader.result;
      };
      if (file) {
    ...
    submitForm() {
      ...
      formData.append(
        "dependent_birth_certificate_validity_date",
        this.dependent_birth_certificate_validity_date
      );
      formData.append(
        "dependent_birth_certificate_printed_date",
        this.dependent_birth_certificate_printed_date
      );
      formData.append(
        "dependent_birth_certificate_remarks",
      ...
      if (this.dependent_birth_certificate_proof) {
        const file = this.dataURLtoBlob(this.dependent_birth_certificate_proof);
        formData.append("dependent_birth_certificate_image", file);
      }
