...
export default {
  ...
  methods: {
    uploadImage(event) {
      ...
      reader.onload = () => {
        this.previous_employment_proof = reader.result;
      };
      if (file) {
    ...
    submitForm() {
      ...
      formData.append(
        "previous_employment_validity_date",
        this.previous_employment_validity_date
      );
      formData.append(
        "previous_employment_printed_date",
        this.previous_employment_printed_date
      );
      formData.append(
        "previous_employment_remarks",
      ...
      if (this.previous_employment_proof) {
        const file = this.dataURLtoBlob(this.previous_employment_proof);
        formData.append("previous_employment_image", file);
      }
