...
export default {
  ...
  methods: {
    ...
    submitForm() {
      ...
      formData.append("ofac_validity_date", this.ofac_validity_date);
      formData.append("ofac_printed_date", this.ofac_printed_date);
      formData.append("ofac_remarks", this.ofac_remarks);

      if (this.ofac_proof) {
        const file = this.dataURLtoBlob(this.ofac_proof);
        formData.append("ofac_image", file);
      }
