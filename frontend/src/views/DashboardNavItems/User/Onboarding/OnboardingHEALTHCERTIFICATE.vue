...
export default {
  ...
  methods: {
    uploadImage(event) {
      ...
      reader.onload = () => {
        this.health_certificate_proof = reader.result;
      };
      if (file) {
    ...
    submitForm() {
      ...
      formData.append(
        "health_certificate_printed_date",
        this.health_certificate_printed_date
      );
      formData.append(
        "health_certificate_remarks",
      ...
      if (this.health_certificate_proof) {
        const file = this.dataURLtoBlob(this.health_certificate_proof);
        formData.append("health_certificate_image", file);
      }
