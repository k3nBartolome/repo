...
export default {
  ...
  methods: {
    uploadImage(event) {
      ...
      reader.onload = () => {
        this.marriage_certificate_proof = reader.result;
      };
      if (file) {
    ...
    submitForm() {
      ...
      formData.append(
        "marriage_certificate_validity_date",
        this.marriage_certificate_validity_date
      );
      formData.append(
        "marriage_certificate_printed_date",
        this.marriage_certificate_printed_date
      );
      formData.append(
        "marriage_certificate_remarks",
      ...
      if (this.marriage_certificate_proof) {
        const file = this.dataURLtoBlob(this.marriage_certificate_proof);
        formData.append("marriage_certificate_image", file);
      }
