          ...
          <div class="flex items-center">
            ...
            <div class="hidden md:block ml-10 flex-grow">
              <div class="flex items-baseline space-x-4 justify-center">
                <router-link to="/capfilejamaica" class=" hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium link-button"  v-if="isUser">Capacity File</router-link>
                <div class="dropdown" @mouseover="openDropdown" @mouseleave="closeDropdown" @click="toggleDropdown">
                  ...
                  <div v-show="dropdownOpen" class="dropdown-content">
                    <router-link to="/site_managementjamaica" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900" role="menuitem">Sites</router-link>
                    <router-link to="/program_managementjamaica" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900" role="menuitem">Programs</router-link>
                  </div>
                </div>
              </div>
            </div>
